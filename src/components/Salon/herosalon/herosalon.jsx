...
import images from './herosalons.jpg'
    ...
    return (
        <div  id='herosalon'>
            <div className="container">
                <div style={{background:`url(${images})`}} className="herosalon">
                    <div className="herosalon--hello">
                        <div className="herosalon--hello__recom-text">
                            <h1>завоевывая мир сегодня</h1>
                            <p>Наши талантливые специалисты готовы поделиться своими секретами. Не упустите эту возможность</p>
                        </div>
                        <div className="herosalon--hello__block">
                            <div className="herosalon--hello__block--blocks">
                                <h1>Лучшие мастера недели по отзывам клиентов</h1>
                                <img src={str} alt="" />
                                <div className="herosalon--hello__block--blocks__flex">
                                    <div>
                                        <h2>{str2}</h2>
                                ...
                                <div className="herosalon--hello__block--blocks__flexs">
                                    <button>Смотреть</button>
                                    <div className='herosalon--hello__block--blocks__flexs--icons'>
