    ...
    return (
        <div  id='salonRecom'>
            <div className="container">
                <div style={{background:`url(${heros})`}} className="salonRecom">
                    <div className="salonRecom--hello">
                        <div className="salonRecom--hello__recom-text">
                        ...
                        <div className="salonRecom--hello__block">
                            <div className="salonRecom--hello__block--blocks">
                                <h1>Лучшие мастера недели по отзывам клиентов</h1>
                                <img src={str} alt="" />
                                <div className="salonRecom--hello__block--blocks__flex">
                                    <div>
                                        <h2>{str2}</h2>
                                ...
                                <div className="salonRecom--hello__block--blocks__flexs">
                                    <button>Смотреть</button>
                                    <div className='salonRecom--hello__block--blocks__flexs--icons'>
